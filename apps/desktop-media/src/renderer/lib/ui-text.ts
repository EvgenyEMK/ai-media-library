export const UI_TEXT = {
  ...
  folderFaceSummaryVariantA: "Variant A",
  folderFaceSummaryVariantB: "Variant B",
  folderFaceSummaryVariantC: "Variant C",
  folderFaceSummaryCardCoverage: "Processed files",
  folderFaceSummaryCardOutcomes: "Detected faces",
  folderFaceSummaryCardTagging: "Tagged faces",
  folderFaceSummaryCardAgeGender: "Age + gender",
  folderFaceSummaryCardMainSubjects: "Main subjects",
  folderFaceSummaryCardTopTags: "Top person-tags",
  folderFaceSummaryViewDetails: "View details",
